                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend{{ $base_url }}.</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search{{ $base_url }}.">
